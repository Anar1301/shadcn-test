...
import { MedMovieCard, PaginationComp } from "@/src/components/general";
import { GenreMobileComp, GenresListCard } from "@/src/components/genre";
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
} from "@/src/components/ui";
import { genreResponseType, movieResponseType } from "@/src/types";
import { getGenresList, getMoviesByGenreId } from "@/src/utils/get-data";
